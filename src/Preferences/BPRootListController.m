...
- (NSArray *)rootSpecifiers {
	return @[
        ...
        @{
            ...
            @"key": BPKeyForHideReadAndTypingKey,
		...
		@{
            ...
            @"default": @(NO),
            @"detail": @"HBListItemsController",
            @"key": BPKeyForScreenshotReporting,
		...
		@{
            ...
            @"default": @(NO),
            @"detail": @"HBListItemsController",
            @"key": BPKeyForTimedMessagesForever,
